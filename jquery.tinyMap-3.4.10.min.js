...
(function(g,u,q,I){function z(a){var b;if(a instanceof Array)for(b=0;b<a.length;b+=1)z(a[b]);else if("object"===typeof a)for(b in a)if("string"!==typeof a[b])z(a[b]);else if(/^google\.map/gi.test(a[b])){var d=a[b].split(".");4===d.length&&(a[b]=google.maps[d[2]][d[3]])}}function t(a,b,d){var c={lat:"",lng:""},e=/^[+-]?\d+(\.\d+)?$/;if("string"===typeof a||Array.isArray(a)){var f=Array.isArray(a)?a:a.toString().replace(/\s+/,"").split(",");if(2===f.length)e.test(f[0])&&e.test(f[1])&&(c.lat=f[0],c.lng=
...
0;e<b.kml.length;e+=1)"string"===typeof b.kml[e]?(d.url=b.kml[e],c=new google.maps.KmlLayer(d)):"object"===typeof b.kml[e]&&(d=g.extend({},d,b.kml[e]),c=new google.maps.KmlLayer(d),d.hasOwnProperty("event")&&this.bindEvents(c,d.event)),this._kmls.push(c)},drawPolyline:function(a,b){var d={},c=[],e={},f={},h={};h={};var k=[],n=[],m=0;h={};h={};var l=0,r=function(a,b){if(b===google.maps.DirectionsStatus.OK){for(l=0;l<a.routes[0].overview_path.length;l+=1)n.push(a.routes[0].overview_path[l]);e.setPath(n);
"function"===typeof d.getDistance&&(f=a.routes[0].legs[0].distance,d.getDistance.call(this,f))}};if(b.hasOwnProperty("polyline")&&Array.isArray(b.polyline))for(m=0;m<b.polyline.length;m+=1)if(d=b.polyline[m],d.hasOwnProperty("coords")&&Array.isArray(d.coords)){k=new google.maps.MVCArray;for(l=0;l<d.coords.length;l+=1)h=d.coords[l],h=t(h,!0,!1),"function"===typeof h.lat&&k.push(h);h=g.extend({},{strokeColor:d.color||"#FF0000",strokeOpacity:d.opacity||1,strokeWeight:d.width||2},d);e=new google.maps.Polyline(h);
this._polylines.push(e);if(2<k.getLength())for(l=0;l<k.length;l+=1)0<l&&k.length-1>l&&c.push({location:k.getAt(l),stopover:!1});d.hasOwnProperty("event")&&this.bindEvents(e,d.event);d.hasOwnProperty("snap")&&!0===d.snap?(h=new google.maps.DirectionsService,h.route({origin:k.getAt(0),waypoints:c,destination:k.getAt(k.length-1),travelMode:google.maps.DirectionsTravelMode.DRIVING},r)):(e.setPath(k),google.maps.hasOwnProperty("geometry")&&google.maps.geometry.hasOwnProperty("spherical")&&"function"===
typeof google.maps.geometry.spherical.computeDistanceBetween&&(f=google.maps.geometry.spherical.computeDistanceBetween(k.getAt(0),k.getAt(k.length-1)),"function"===typeof d.getDistance&&d.getDistance.call(this,f)));e.setMap(a)}},drawPolygon:function(a,b){var d,c;if(b.hasOwnProperty("polygon")&&Array.isArray(b.polygon))for(c=0;c<b.polygon.length;c+=1){var e=[];if(b.polygon[c].hasOwnProperty("coords")){for(d=0;d<b.polygon[c].coords.length;d+=1){var f=b.polygon[c].coords[d];f=t(f,!0,!1);"function"===
...
c.infoWindow.open(a.map,c),!0===d.panTo&&a.map.panTo(c.getPosition()),"function"===typeof d.onChange&&d.onChange.call(b,c))})}).html(e.join(""));"string"===typeof d.css&&c.find("select").addClass(d.css)})}},placeMarkers:function(a,b,d,c){var e=this,f={},h={maxZoom:null,gridSize:60},k=Array.isArray(b.marker)?b.marker:[],n={},m=!1;"undefined"!==typeof c&&Array.isArray(c)&&c.length&&(k=c);e.options.hasOwnProperty("markerCluster")&&"function"===typeof MarkerClusterer&&(h=g.extend({},h,b.markerCluster),
e._clusters=new MarkerClusterer(a,[],h),h.hasOwnProperty("event")&&e.bindEvents(e._clusters,h.event));e.options.hasOwnProperty("enableOMS")&&"function"===typeof OverlappingMarkerSpiderfier&&(m=!0);m&&(n=new OverlappingMarkerSpiderfier(a,{markersWontHide:!0}),n.addListener("click",function(b){b.hasOwnProperty("oms")&&b.infoWindow.setContent(b.oms);b.infoWindow.open(a,b)}),n.addListener("spiderfy",function(a){}),n.addListener("unspiderfy",function(a){}));var l=k.length;k.forEach(function(c,k){var h=
t(c.addr,!0),r=e.markerIcon(c),v=!0,C=!1,q={},w={},u="undefined"!==typeof c.id?c.id:c.addr.toString().replace(/\s/g,""),p={id:u,map:a,animation:null,showLabel:!0};p=g.extend({},p,c);"modify"===d&&u&&e.get({marker:[u]},function(a){!Array.isArray(a.marker)||!a.marker.length||c.hasOwnProperty("forceInsert")&&!0===c.forceInsert||(c=g.extend(a.marker[0],c),"function"===typeof e._clusters.removeMarker&&e._clusters.removeMarker(a.marker[0]),v=!1,C=!0)});c.hasOwnProperty("title")&&(p.title=c.title.toString().replace(/<([^>]+)>/g,
""));g.isEmptyObject(r)||(p.icon=r);c.hasOwnProperty("animation")&&"string"===typeof c.animation&&(p.animation=google.maps.Animation[c.animation.toUpperCase()]);"string"===typeof h?(f=new google.maps.Geocoder,f.geocode({address:h},function(f,h){h===google.maps.GeocoderStatus.OVER_QUERY_LIMIT?setTimeout(function(){e.placeMarkers(l,a,b,d,[c])},e.interval*(k+1)):h===google.maps.GeocoderStatus.OK&&(!v&&C?("function"===typeof c.setPosition&&(c.setPosition(f[0].geometry.location),p.hasOwnProperty("title")&&
c.setTitle(p.title),p.hasOwnProperty("icon")&&c.setIcon(p.icon)),w=c):(p.position=f[0].geometry.location,q=b.hasOwnProperty("markerWithLabel")&&!0===b.markerWithLabel?"function"===typeof MarkerWithLabel?new MarkerWithLabel(p):new google.maps.Marker(p):new google.maps.Marker(p),e._markers.push(q),w=q),m&&n.addMarker(w),e.processMarker(l,a,b,w,d))})):(!v&&C?("function"===typeof c.setPosition&&h.lat()&&h.lng()&&c.setPosition(h),p.hasOwnProperty("title")&&c.setTitle(p.title),p.hasOwnProperty("icon")&&
...
k=g.extend({},{infoWindow:new google.maps.InfoWindow,map:d.map},b),n=[],m=[],l=[];e.origin=t(b.from,!0,!1);e.destination=t(b.to,!0,!1);e.travelMode=b.hasOwnProperty("travel")&&google.maps.TravelMode[b.travel.toString().toUpperCase()]?google.maps.TravelMode[b.travel.toString().toUpperCase()]:google.maps.TravelMode.DRIVING;b.hasOwnProperty("panel")&&g(b.panel).length&&(k.panel=g(b.panel).get(0));b.hasOwnProperty("requestExtra")&&b.requestExtra&&(e=g.extend({},e,b.requestExtra));b.hasOwnProperty("optimize")&&
(e.optimizeWaypoints=b.optimize);b.hasOwnProperty("waypoint")&&Array.isArray(b.waypoint)&&(b.waypoint.forEach(function(a){var b={stopover:!0};"string"===typeof a||Array.isArray(a)?b.location=t(a,!0):a.hasOwnProperty("location")&&(b.location=t(a.location,!0),b.stopover=a.hasOwnProperty("stopover")?a.stopover:!0);m.push(a.text||a.toString());a.hasOwnProperty("icon")&&l.push(a.icon.toString());n.push(b)}),e.waypoints=n);c.route(e,function(c,f){f===google.maps.DirectionsStatus.OK&&(c.routes.forEach(function(f,
h){b.hasOwnProperty("renderAll")&&!0===b.renderAll&&!0===e.provideRouteAlternatives&&new google.maps.DirectionsRenderer({map:a,directions:c,routeIndex:h});var g=f.legs,r="",n="",v={};b.hasOwnProperty("fromText")&&(r=g[0].start_address=b.fromText);b.hasOwnProperty("toText")&&(1===g.length?g[0].end_address=b.toText:g[g.length-1].end_address=b.toText,n=b.toText);b.hasOwnProperty("icon")&&(k.suppressMarkers=!0,b.icon.hasOwnProperty("from")&&"string"===typeof b.icon.from&&d.directionServiceMarker(g[0].start_location,
{icon:b.icon.from,text:r},k.infoWindow,b),b.icon.hasOwnProperty("to")&&"string"===typeof b.icon.to&&d.directionServiceMarker(g[g.length-1].end_location,{icon:b.icon.to,text:n},k.infoWindow,b));for(r=1;r<g.length;r+=1)b.hasOwnProperty("icon")&&(b.icon.hasOwnProperty("waypoint")&&"string"===typeof b.icon.waypoint?v.icon=b.icon.waypoint:"string"===typeof l[r-1]&&(v.icon=l[r-1]),v.text=m[r-1],d.directionServiceMarker(g[r].start_location,v,k.infoWindow,b))}),console.log(k),d.bindEvents(h,b.event),h.setOptions(k),
...
typeof d.routes[0]&&"undefined"!==typeof d.routes[0].legs&&(a[c]=[],d.routes[0].legs.forEach(function(b,d){a[c].push({from:b.start_address,to:b.end_address,distance:b.distance,duration:b.duration})}))})});return a},streetView:function(a,b){var d=b.hasOwnProperty("streetViewObj")?b.streetViewObj:{};if("function"===typeof a.getStreetView){if(d.hasOwnProperty("position")){var c=t(d.position,!0,!1);d.position="object"===typeof c?a.getCenter():c}else d.position=a.getCenter();d.hasOwnProperty("pov")&&(d.pov=
...
"function"===typeof a.infoWindow.close&&a.infoWindow.close()});"function"===typeof b&&b.call(this)}catch(f){console.warn(f)}finally{return g(this.container)}},clear:function(a,b){function d(a,b){"function"===typeof a.setMap&&f._directionsMarkers[b].setMap(null)}function c(a){"direction"===l&&(h.forEach(d),f._directionsMarkers.filter(function(a){return"undefined"!==typeof a}));"function"===typeof a.set&&a.set("visible",!1);"function"===typeof a.setMap&&a.setMap(null);-1!==f[m].indexOf(a)&&delete f[m][f[m].indexOf(a)]}
function e(a){return"undefined"!==typeof a}var f=this,h=f._directionsMarkers,k=f.get(a),n={},m="",l="";"undefined"!==typeof k&&"undefined"!==typeof k.map&&delete k.map;Array.isArray(k)?n[a]=k:n=k;try{for(l in n)Array.isArray(n[l])&&(m="_"+l.toString().toLowerCase()+"s",n[l].forEach(c),f[m]=f[m].filter(e));"function"===typeof b&&b.call(this)}catch(r){console.warn(r)}finally{return g(f.container)}},get:function(a,b){function d(b){var d=c[k].indexOf(b);(0===a[h].length||-1!==a[h].indexOf(d)||"undefined"!==
typeof b.id&&0<b.id.length&&-1!==b.id.indexOf(a[h]))&&f[h].push(b)}var c=this,e=[],f={},h={},k="",g="",m=0;"undefined"===typeof a&&(a={marker:[],label:[],polygon:[],polyline:[],circle:[],direction:[],kml:[],cluster:[],bound:[]});try{if("string"===typeof a)if(-1!==a.indexOf(","))for(e=a.replace(/\s/gi,"").split(","),m=0;m<e.length;m+=1)g=e[m].toString().toLowerCase(),"map"===g?f[g]=c.map:(console.log(g),k="_"+g+"s",f[g]=c[k]);else"map"===a.toString().toLowerCase()?f=c.map:(k="_"+a.toString().toLowerCase()+
"s",f=c[k]);else{for(h in a)Array.isArray(a[h])&&(k="_"+h.toString().toLowerCase()+"s",Array.isArray(c[k])&&(f[h]=[],c[k].forEach(d)));f.map=c.map}"function"===typeof b&&b.call(this,f);return f}catch(l){console.error(l)}finally{return f}},modify:function(a){var b=[],d=[["kml","kml"],["marker","placeMarkers"],["direction","directionService"],["polyline","drawPolyline"],["polygon","drawPolygon"],["circle","drawCircle"],["streetView","streetView"],["markerFitBounds","markerFitBounds"],["places","places"],
